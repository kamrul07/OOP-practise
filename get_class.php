...
?>;overflow: hidden;" >
        ...
        <h2 style="font-size:38px;text-align:center">OOP tutorials</h2>
               ...
               <br>
               <h2>__class__ --- returns the parent class name </h2>
               <h2>get_class($this) --- returns the class name of object</h2>
               <hr>
               <br> 
           ...
           class a{
                public function a1(){
                    echo "THis is first class and the class name ".__class__."<br>";
                    echo "THis is first class and the class name ".get_class($this)."<br>";
